...
public class MyMapFragment extends Fragment implements OnMapReadyCallback {
    ...
    public void onMapReady(final GoogleMap googleMap) {
        ...
        final GsonRequest gsonRequest = new GsonRequest("http://selectunes.eu/api/test", new TypeToken<List<Incident>>() {
        }.getType(), null, successIncidentListener(), errorIncidentListener());
        ...
        return new Response.Listener<List<Incident>>() {
            ...
            public void onResponse(final List<Incident> incidents) {
                ...
                for (Incident incident : incidents) {
                    ...
                    Log.v(LOG_TAG, incident.getIncidentTypeID().toString());
                }
            }
        };
    }
